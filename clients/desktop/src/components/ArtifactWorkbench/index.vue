...
.awb-tree-panel, .awb-code, .awb-editor-wrap, .awb-table-wrap, .awb-export-tree { scrollbar-width: thin; scrollbar-color: #c7d3e4 transparent; }
.awb-tree-panel::-webkit-scrollbar, .awb-code::-webkit-scrollbar, .awb-editor-wrap::-webkit-scrollbar, .awb-table-wrap::-webkit-scrollbar, .awb-export-tree::-webkit-scrollbar { width: 3px; height: 3px; }
.awb-tree-panel::-webkit-scrollbar-track, .awb-code::-webkit-scrollbar-track, .awb-editor-wrap::-webkit-scrollbar-track, .awb-table-wrap::-webkit-scrollbar-track, .awb-export-tree::-webkit-scrollbar-track { background: transparent; }
.awb-tree-panel::-webkit-scrollbar-thumb, .awb-code::-webkit-scrollbar-thumb, .awb-editor-wrap::-webkit-scrollbar-thumb, .awb-table-wrap::-webkit-scrollbar-thumb, .awb-export-tree::-webkit-scrollbar-thumb { background: #c7d3e4; border-radius: 999px; }
</style>
