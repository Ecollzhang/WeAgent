...
REQUIRED_PRODUCT_WRITE_TOOL = {
    ...
    "product.question_generation": "edu.question_bank.upsert",
    "product.paper_generation": "edu.paper.compose",
    "product.knowledge_research": "edu.knowledge.resource.adopt",
...
REQUIRED_PRODUCT_WRITE_AGENT = {
    ...
    "product.question_generation": "_edu_3",
    "product.paper_generation": "_edu_3",
    "product.knowledge_research": "_edu_8",
