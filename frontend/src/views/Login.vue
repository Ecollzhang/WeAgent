      ...
      slides: [
        {
          ...
          posters: [
            ...
            { icon: '🔗', label: 'API 集成', color: '#ffffff' },
        ...
        },
        {
          badge: '多智能体',
          title: 'AI Agent 协作团队',
          desc: '全栈架构师、前端专家、后端工程师等 AI Agent 协同工作',
          color: 'linear-gradient(135deg, #6366f1, #4f46e5)',
          posters: [
            { icon: '🏗️', label: '全栈架构师', color: '#ffffff' },
            { icon: '🎨', label: '前端开发专家', color: '#ffffff' },
            { icon: '⚙️', label: '后端开发专家', color: '#ffffff' },
            { icon: '🔍', label: '代码审查员', color: '#ffffff' },
            { icon: '🧪', label: '测试工程师', color: '#ffffff' },
            { icon: '📄', label: '文档工程师', color: '#ffffff' },
            { icon: '🗄️', label: '数据库专家', color: '#ffffff' },
            { icon: '🔒', label: '安全专家', color: '#ffffff' },
            { icon: '☁️', label: 'DevOps 工程师', color: '#ffffff' },
            { icon: '📊', label: '数据分析师', color: '#ffffff' },
            { icon: '🤖', label: 'AI 研究员', color: '#ffffff' },
            { icon: '🎯', label: '项目经理', color: '#ffffff' },
          ],
        },
        {
          badge: '核心能力',
          title: '一站式开发平台',
          desc: '知识库检索、代码审查、CI/CD、实时预览等强大功能',
          ...
          posters: [
            ...
            { icon: '🔐', label: 'JWT 安全认证', color: '#ffffff' },
            { icon: '🐳', label: '沙箱容器', color: '#ffffff' },
            { icon: '🌐', label: '服务发现', color: '#ffffff' },
            { icon: '📊', label: '灰度控制', color: '#ffffff' },
