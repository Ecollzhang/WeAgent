      ...
      slides: [
        {
          ...
          posters: [
            { icon: '🤖', label: '多智能体', color: '#ffffff' },
            { icon: '💬', label: '实时聊天', color: '#ffffff' },
            { icon: '📦', label: '产物管理', color: '#ffffff' },
            { icon: '🔐', label: '安全可靠', color: '#ffffff' },
            { icon: '🚀', label: '极速响应', color: '#ffffff' },
            { icon: '🎯', label: '精准输出', color: '#ffffff' },
            { icon: '📊', label: '数据分析', color: '#ffffff' },
            { icon: '🔄', label: '集成能力', color: '#ffffff' },
            { icon: '📝', label: '代码生成', color: '#ffffff' },
            { icon: '✅', label: '代码审查', color: '#ffffff' },
            { icon: '📚', label: '文档', color: '#ffffff' },
            { icon: '☁️', label: '部署', color: '#ffffff' },
          ],
        },
        {
          badge: '团队协作',
          ...
          posters: [
            { icon: '👥', label: '团队聊天', color: '#ffffff' },
            { icon: '📋', label: '任务管理', color: '#ffffff' },
            { icon: '📈', label: '进度追踪', color: '#ffffff' },
            { icon: '🏷️', label: '标签', color: '#ffffff' },
            { icon: '🔔', label: '通知', color: '#ffffff' },
            { icon: '📎', label: '文件共享', color: '#ffffff' },
            { icon: '🗂️', label: '项目管理', color: '#ffffff' },
            { icon: '🔍', label: '全局搜索', color: '#ffffff' },
            { icon: '🌙', label: '深色模式', color: '#ffffff' },
            { icon: '⚙️', label: '设置', color: '#ffffff' },
            { icon: '🎨', label: '自定义', color: '#ffffff' },
        ...
        },
        {
          ...
          posters: [
            { icon: '🎉', label: '免费版', color: '#ffffff' },
            { icon: '💎', label: '专业版', color: '#ffffff' },
            { icon: '👑', label: '企业版', color: '#ffffff' },
            { icon: '🎓', label: '学生优惠', color: '#ffffff' },
            { icon: '🤝', label: '社区', color: '#ffffff' },
            { icon: '📖', label: '文档', color: '#ffffff' },
            { icon: '💡', label: '示例', color: '#ffffff' },
            { icon: '🎥', label: '教程', color: '#ffffff' },
            { icon: '🧑‍💻', label: 'API', color: '#ffffff' },
            { icon: '🔌', label: '插件', color: '#ffffff' },
            { icon: '🌐', label: 'SDK', color: '#ffffff' },
            { icon: '❤️', label: '支持', color: '#ffffff' },
          ],
        },
      ],
    }
